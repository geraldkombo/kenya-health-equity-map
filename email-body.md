...
This revision includes an updated author line, fully spelled-out terminology for all government bodies and data sources, and corrected advocacy channel references aligned with Kenya's Community Health Policy 2020-2030 and Primary Health Care Act 2023.
...
**Built to outlast funding cycles.** The platform runs on GitHub Pages at zero ongoing cost. There is no server, no database, no licensing fees. It is an open digital public good that any community, non-governmental organization (NGO), or county health department can fork, adapt, or redistribute. Sustainability is not a future concern to be addressed when the grant expires - it is designed into the architecture from the outset.
...
**Gerald Kombo**
Independent Researcher and Developer, Kenya Health Equity Map (2026)
