          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-stone-100 bg-stone-50 p-4">
              ...
              <p className="mt-1 text-xs leading-5 text-stone-600">
                ...
                poverty / 100, population per facility / 10,000, facilities per 10,000 people / 4), then invert facility density.
              </p>
            </div>
            <div className="rounded-lg border border-stone-100 bg-stone-50 p-4">
            ...
            <div className="rounded-lg border border-stone-100 bg-stone-50 p-4">
              ...
              <p className="mt-1 text-xs leading-5 text-stone-600">
                Each county receives a 0 to 100 Priority Gap Score. Higher scores indicate greater access inequity.
              </p>
            </div>
          </div>
        </section>
...
secondary, and rural road networks (<a href="https://www.openstreetmap.org/relation/192798" target="_blank" rel="noreferrer" className="underline underline-offset-2 hover:text-stone-900">OSM Kenya</a>).
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-stone-100 bg-stone-50 p-4">
              <h3 className="text-sm font-semibold text-stone-800">Motorized and Manual Transport (On road)</h3>
              <p className="mt-1 text-xs leading-5 text-stone-600">
                Once the simulated person reaches a road, speed shifts by road classification: primary roads
                assume motorized transport (~50 km/h), while rural roads assume cycling or walking (5 to 10 km/h).
              </p>
            </div>
          </div>
          <div className="mt-4 rounded-lg border border-stone-200 bg-stone-50 p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-stone-600">
              Researchers use Geographic Information Systems (GIS) running a lowest cost path algorithm
        ...
        <section className="rounded-xl border border-stone-200 bg-white p-6">
          ...
          <div className="mt-4 space-y-5 text-sm leading-6 text-stone-700">
            <div className="border-l-4 border-stone-700 pl-4">
              <h3 className="font-medium text-stone-800">Accessibility, 40% (default)</h3>
            ...
            <div className="border-l-4 border-[#EA580C] pl-4">
              <h3 className="font-medium text-stone-800">Vulnerability, 30% (default)</h3>
              <p className="mt-1 text-stone-600">
            ...
            <div className="border-l-4 border-[#F59E0B] pl-4">
              <h3 className="font-medium text-stone-800">Population Pressure, 30% (default)</h3>
              <p className="mt-1 text-stone-600">
        ...
        <section className="rounded-xl border border-stone-200 bg-white p-6">
          ...
          <div className="mt-3 rounded-lg bg-stone-50 p-5 text-xs leading-6 text-stone-700">
            ...
            <p className="mt-3 text-stone-400">
              ...
              population per facility / 10,000, facilities per 10,000 people / 4 inverted) before
              aggregation. The result is multiplied by 100 to produce a 0 to 100 index. Scores are
              stable and comparable across data refreshes.
            </p>
          </div>
        </section>
        ...
        <section className="rounded-xl border border-stone-200 bg-white p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-stone-700">
            ...
            reflect actual conditions rather than straight line distance.
          </p>
        </section>
