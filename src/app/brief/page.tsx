...
road networks (<a href="https://www.openstreetmap.org/relation/192798" target="_blank" rel="noreferrer" className="underline underline-offset-2 hover:text-stone-800">OSM Kenya</a>).
        ...
        <p className="mt-2 text-[10px] leading-5 text-stone-400">
          Suggested citation: Kenya Health Equity Map, <a href="https://kenya-equity.netlify.app" target="_blank" rel="noreferrer" className="underline underline-offset-2 hover:text-stone-600">kenya-equity.netlify.app</a>.
...
function BriefContent() {
  ...
  const handlePrint = useReactToPrint({
    contentRef: printRef,
    documentTitle: `kenya-equity-brief-${selected?.name?.toLowerCase().replace(/\s+/g, "-") ?? countyCode}`,
    pageStyle: `
