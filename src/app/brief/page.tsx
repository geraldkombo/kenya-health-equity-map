    ...
    <div className="p-8 print:p-0 flex flex-col">
      <div className="space-y-3 print:space-y-3">
        ...
        <div className="break-inside-avoid border border-stone-300 rounded-lg p-3 print:p-2 bg-white">
          <h3 className="text-[11px] print:text-[8pt] font-bold text-stone-900 uppercase tracking-wider mb-1.5">County Health Management Team Action Notes</h3>
...
function BriefContent() {
  ...
  const loaded = counties !== null;
  const notFound = loaded && !!countyCode && !selected;
    ...
    <div className="min-h-[100svh] bg-stone-100 text-[#292524]">
      <div className="mx-auto max-w-3xl px-4 py-6 sm:px-8 sm:py-8">
        ...
        {!countyCode ? (
          ...
          <div className="mt-8 rounded-[8px] border border-amber-200 bg-amber-50 p-8 text-[14px] text-amber-800 print:hidden">
            County not found. The link may be incorrect. Please return to the map and select a county.
          </div>
        ) : !ready ? (
          <div className="mt-8 rounded-[8px] border border-[#E0DBD0] bg-white p-8 text-[14px] text-[#524B3F] print:hidden">
