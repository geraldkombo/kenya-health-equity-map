...
export const REAL_SOURCES: Record<string, SourceEntry[]> = {
  ...
  methods: [
    ...
    },
    {
      ...
      license: "Research",
      note: "Kenya's leading health research institute. Their geographic access group produces the travel time friction surfaces and cost and distance models that underpin this platform's accessibility metric.",
      type: "research",
    },
    {
      ...
      note: "Daily OSM extracts for Kenya in .osm.pbf format. Used as the road network input for AccessMod cost and distance modelling and Protomaps vector tile generation.",
      type: "download",
    },
    {
