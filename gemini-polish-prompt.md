Polish the following abstract submission text for a formal academic conference (3rd CSS Knowledge Dissemination Forum, Sub-theme 2: Digital Health and Evidence Generation Through Community-Led Monitoring). The audience is public health professionals, donors, and community advocates in Kenya.

Rules:
1. Replace "wealthy urban women" with a more precise, neutral term like "higher-income urban women" or "affluent households"
2. Keep all Kenyan place names, data points, and acronyms exactly as written (PGS, CHMT, CLM, KNBS, KIHBS, KDHS, WHO, eCHIS, NGO, ASAL)
3. No long dashes — use regular hyphens or commas instead
4. Keep the overall structure, section breaks, and tone
5. Ensure plain language suitable for community health audiences
